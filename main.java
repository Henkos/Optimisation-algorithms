...
public class main 
{
	...
	public static void main(String[] args)  throws Exception
	{
	    ...
	    //PFSP instances 1 matrix m*n : n,m,m
		 ...
		 {
			 if(obfuname.equals("PFSP")) p.run(ptype,n,m,m, R, i, fname,fnamebest,obfuname,signi,zsigni,neimins,pacct);
			  else if(obfuname.equals("LOP")) p.run(ptype,o,o,o, R, i, fname,fnamebest,obfuname,signi,zsigni,neimins,pacct);
			   else p.run(ptype,o,o,2*o, R, i, fname,fnamebest,obfuname,signi,zsigni,neimins,pacct);
