...
public class Procedure
{
	...
	///////////////
	public void run(int ptype,int n,int m, int q, Random R,int round,String fname,String fnamebest,String obfuname,double signi,double zsigni,int neimins,double pacct) throws Exception
	{
		//
		int howOften = 100;
		...
		double[][] coef2opt = pdo.create(ptype,n,m,R,2,round,factor,obfuname,signi,zsigni,neimins,pacct);
		double[][] coef3opt = pdo.create(ptype,n,m,R,3,round,factor,obfuname,signi,zsigni,neimins,pacct);
		double[][] coefkopt = pdo.create(ptype,n,m,R,4,round,factor,obfuname,signi,zsigni,neimins,pacct);
		double[][] coefkoptd = pdo.create(ptype,n,m,R,5,round,factor,obfuname,signi,zsigni,neimins,pacct);
		 //*******************************end ofPHASE
		//read the global
