...
public class PDO
{
	...
	public double[][] create(int ptype,int n, int m, int v, Random R,int k,int round,int[][] factor,String obfuname,double signi,double zsigni,int neimins,double pacct)
	{
